...
namespace OOP_TEST_
{
    public partial class PatientRegister : Form
    {
        ...
        private void RegisterBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string query = "INSERT INTO tb_patient (Firstname, Lastname, Username, ContactNumber, Password, password1) VALUES (@Firstname, @Lastname, @Username, @ContactNumber,  @Password, @Password1)";
